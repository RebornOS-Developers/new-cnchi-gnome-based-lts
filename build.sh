...
make_boot() {
    ...
    cp "${work_dir}/x86_64/airootfs/boot/archiso-lts.img" "${work_dir}/iso/${install_dir}/boot/x86_64/"
    cp "${work_dir}/x86_64/airootfs/boot/vmlinuz-linux-lts" "${work_dir}/iso/${install_dir}/boot/x86_64/"
}
...
make_efiboot() {
    ...
    cp "${work_dir}/iso/${install_dir}/boot/x86_64/vmlinuz-linux-lts" "${work_dir}/efiboot/EFI/archiso/"
    cp "${work_dir}/iso/${install_dir}/boot/x86_64/archiso-lts.img" "${work_dir}/efiboot/EFI/archiso/"
