...
arch_chroot "
wget https://repo.rebornos.org/RebornOS/sources/cnchi/testing/new-cnchi-lts-20210625-2-any.pkg.tar.zst
tar -xvf new-cnchi-lts-20210625-2-any.pkg.tar.zst
rm new-cnchi-lts-20210625-2-any.pkg.tar.zst
